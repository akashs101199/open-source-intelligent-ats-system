      ...
      {!selectedFile ? (
        ...
        >
          ...
          <input
            ...
            disabled={loading}
          />
          <Button onClick={() => fileInputRef.current?.click()} disabled={loading} className="mb-3">
            Choose Resume
          </Button>
          <p className="text-sm text-gray-400 mb-1">or drag and drop your file here</p>
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-2">Candidate Name (optional)</label>
            <input
          ...
          <div className="flex gap-3">
            <Button onClick={handleUpload} disabled={loading} loading={loading} className="flex-1">
